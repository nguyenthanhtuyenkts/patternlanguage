...
### Related Patterns
... this pattern forms the backbone of the [[2. The Distribution of Towns]], which requires that scores of smaller country towns support the larger towns and cities of the region.

Treat each of these small towns as a political community, with full provision for all the stages of human life -- [[12. Community of 7000]], [[26. Life Cycle]]. Treat the belt of open country which surrounds the town as farm land which belongs to the people and can be freely used by them -- [[7. The Countryside]] ...
