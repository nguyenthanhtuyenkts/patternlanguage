...
### Related Patterns
... the city, as defined by [[3. City Country Fingers]], spreads out in a ribbon fashion, throughout the countryside, and is broken into [[11. Local Transport Areas]]. To connect the transport areas, and to maintain the flow of people and goods along the fingers of the cities, it is now necessary to create a web of public transportation.

Keep all the various lines that converge on a single interchange, and their parking, within 600 feet, so that people can transfer on foot -- [[34. Interchange]]. It is essential that the major stations are served by a good feeder system, so that people are not forced to use private cars at all -- [[20. Mini-Buses]] ...
