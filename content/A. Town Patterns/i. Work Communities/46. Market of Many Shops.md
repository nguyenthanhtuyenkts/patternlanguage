...
### Related Patterns
... we have a proposed that shops be widely decentralized and placed in such a way that they are most accessible to the communities which use them -- [[19. Web of Shopping]]. The largest groups of shops are arranged to form pedestrian streets or [[32. Shopping Street]] which will almost need a market to survive. This pattern describes the form and economic character of markets.

Make the aisles wide enough for small delivery carts and for a a dense throng of pedestrians -- perhaps 6 to 12 feet wide -- [[101. Building Thoroughfare]]; keep the stalls extremely small so that the rent is low -- perhaps no more than six by nine feet -- [[87. Individually Owned Shops]]; define the stalls with columns at the corners only -- [[212. Columns at the Corners]]; perhaps even let the owners make roofs for themselves -- [[244. Canvas Roofs]]; connect the aisles with the outside so that the market is a direct continuation of the pedestrian paths in the city just around it -- [[100. Pedestrian Street]] ...
