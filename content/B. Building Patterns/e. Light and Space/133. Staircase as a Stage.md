...
### Related Patterns
... if the entrances are in position - [[110. Main Entrance]]; and the pattern of movement through the building is established - [[131. The Flow Through Rooms]], [[132. Short Passages]], the main stairs must be put in and given an appropriate social character.

Treat the bottom steps as [[125. Stair Seats]]; provide a window or a view half-way up the stair, both to light the stair and to create a natural focus of attention - [[134. Zen View]], [[135. Tapestry of Light and Dark]]; remember to calculate the length and shape of the stair while you are working out its position - [[195. Staircase Volume]]. Get the final shape of the staircase room and the beginnings of its construction from [[191. The Shape of Indoor Space]] ...
