...
### Related Patterns
... this pattern helps you place doors exactly. Use it to help create the larger [[131. The Flow Through Rooms]]. You can use it too, to generate a [[142. Sequence of Sitting Spaces]], by leaving small corners for sitting, uninterrupted by the doors; and you can use it to create [[135. Tapestry of Light and Dark]], since every door, if glazed and near a window, will create a natural pool of light which people gravitate toward.

When a door marks a transition, as it does into a bedroom or a private place, for instance, make it as low as you dare - [[224. Low Doorway]] ; and thicken the entry way with closet space where it needs to be especially private - [[198. Closets Between Rooms]]. Later, when you make the door frame, make it integral with the wall, and decorate it freely - [[225. Frames as Thickened Edges]], [[249. Ornament]]; except when rooms are very private, put windows in the door - [[237. Solid Doors with Glass]] ...
