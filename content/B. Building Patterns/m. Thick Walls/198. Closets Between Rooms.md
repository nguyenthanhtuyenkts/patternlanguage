...
### Related Patterns
... given the layout of rooms, it is now necessary to decide exactly where to put the built-in cupboards and closets. Use them, especially, to help form the enclosure around a workspace - [[183. Workspace Enclosure]], around a dressing space - [[189. Dressing Rooms|Dressing Room (189)]], and around the doors of rather private rooms so that the doorway itself gets some depth - [[196. Corner Doors]].

Later, include the closets as part of the overall building structure - [[197. Thick Walls]] ...
