...
### Related Patterns
... once you have a rough column plan for the building - [[212. Columns at the Corners]], [[213. Final Column Distribution]] - you are ready to start the site work itself. First, stake out the positions of the ground floor columns, before you do any other earthwork, so that you can move the columns whenever necessary to leave rocks or plants intact - [[104. Site Repair]], [[168. Connection to the Earth]]. Then dig the foundation pits and prepare to make the foundations.

To make foundations like this for hollow concrete, filled box columns, start with a pit for each foundation, place the hollow column in the pit, and pour the column and the foundation integrally, in one continuous pour - [[216. Box Columns]]. Later, when you build the ground floor slab, tie the concrete into the foundations - [[215. Ground Floor Slab]] ...
