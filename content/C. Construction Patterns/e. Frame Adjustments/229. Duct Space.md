...
### Related Patterns
... in a building built according to the principle, of [[206. Efficient Structure]] and built with vaulted floors - [[219. Floor-Ceiling Vaults]], there is a triangular volume, unused, around the edge of every room. This is the most natural place to put the ducts.

Once the duct is in, you can fill up the triangle with lightweight concrete - [[219. Floor-Ceiling Vaults]]. Place heating panels along the surface of the triangle - [[230. Radiant Heat]]; and place outlets for lights at frequent intervals below the duct, with leads and conduits running down in rebates along the window frames - [[252. Pools of Light]] ...
